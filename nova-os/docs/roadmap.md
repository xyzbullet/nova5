...
## Phase 2: Linux application path

- Package and pin the Linuxulator runtime.
- Add Vulkan, OpenGL, audio, filesystem, and portal integration.
- Ship a signed runtime manifest format.
- Validate a small set of development and productivity applications.
